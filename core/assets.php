 ...
 * JS
 */
define('JS_JQUERY', PATH_TO_JS . 'jquery-2.0.0.min.js');
define('JS_JQUERY_UI', PATH_TO_JS . 'jquery-ui.min.js');
define('JS_JQUERY_UI_AUTOCOMPLETE_HTML', PATH_TO_JS . 'jquery.ui.autocomplete.html.js');
define('JS_BOOTSTRAP', PATH_TO_JS . 'bootstrap.min.js');
define('JS_TABLESORTER', PATH_TO_JS . 'jquery.tablesorter.min.js');
define('JS_D3', PATH_TO_JS . 'd3.v3.min.js');
