<div id="submenu">
    ...
    <form id="search">
        <input type="text" id="query" autocomplete="off" autofocus="true"
...
<div id="content">
    ...
    <div id="help">
        ...
        <p>
            ...
            If you are looking for a user who already created himself so called vanity URL, you can use it too. Here's
            how it
